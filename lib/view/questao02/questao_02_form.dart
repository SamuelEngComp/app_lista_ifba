...
import 'package:flutter_application_1/controllers/questao_02_controller.dart';
...
class _Questao02FormularioState extends State<Questao02Formulario> {
  ...
  void checaValores(){
    if(ladoDoQuadrado.text == null){
      ...
      setState(() {
        valorAreaQuadrado = controller.areaQuadrado(int.tryParse(ladoDoQuadrado.text)!);
        valorPerimetroQuadrado = controller.perimetroQuadrado(int.tryParse(ladoDoQuadrado.text)!);
      });
    }
  }
